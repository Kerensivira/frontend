...
import { ArrayPreguntasUX } from "../../Data/dataQuestions";
        ...
        <PaddingHtml>
          ...
          <TextImg>
            ...
            <Title className="text_html" id="textOne">
              {ArrayPreguntasUX[preguntaActual].titulo}
            </Title>
          </TextImg>
          ...
          <ContentOptions>
            <Options>
              ...
              <DivHijo onClick={optionA} className="A">
                {ArrayPreguntasUX[respuesta].opciones.map((respuesta) => (
