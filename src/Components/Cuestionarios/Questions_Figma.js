...
import { ArrayPreguntasFigma } from "../../Data/dataQuestions";
        ...
        <PaddingHtml>
          ...
          <TextImg>
            ...
            <Title className="text_html" id="textOne">
              {ArrayPreguntasFigma[preguntaActual].titulo}
            </Title>
          </TextImg>
          ...
          <ContentOptions>
            <Options>
              ...
              <DivHijo onClick={optionA} className="A">
                {ArrayPreguntasFigma[respuesta].opciones.map((respuesta) => (
...
export default Questions_Figma;
