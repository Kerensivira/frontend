...
import { arrayPreguntasCss } from "../../Data/dataQuestions";
        ...
        <PaddingHtml>
          ...
          <TextImg>
            ...
            <Title className="text_html" id="textOne">
              {arrayPreguntasCss[preguntaActual].titulo}
            </Title>
          </TextImg>
          ...
          <ContentOptions>
            <Options>
              ...
              <DivHijo onClick={optionA} className="A">
                {arrayPreguntasCss[respuesta].opciones.map((respuesta) => (
